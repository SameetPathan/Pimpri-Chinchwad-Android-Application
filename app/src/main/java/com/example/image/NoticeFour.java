...
public class NoticeFour extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText t5,t12,t13,t14,t15;
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notice_four);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Intent Fir   = new Intent(NoticeFour.this,NoticePanel.class);
                startActivity(Fir);
            }
        });
        ///
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            p14=t14.getText().toString();
               ...
               p22=sp2;
                ...
                EditText t23=(EditText) findViewById(R.id.t23);
...
/*
                ...
                try {
                    ...
                    outputStream.write(( "\t\t\t\t\t\t\t\t      पिंपरी चिंचवड महानगरपालिका\n\t\t\t\t" +
                            ...
                            "\t\t\t\t      दिनांक -"+ p3+
                            "\n\n\t\t\t\t\t\tपरिशिष्ट-६" +
                            "\n\t\tमहाराष्ट्र प्रादेशिक नगररचना अधिनियम १९६६ कलम ५५ अन्वये नोटीस" +
                            "\n\nप्रति,"+
                            "\n\tमालक / विकसक / ऑक्युपायर :-" +
                            "\n\t"+p4+" -"+p5+"" +
                            "\n\tपत्ता :- "+p6+" \n" +
                            "\n        ज्या अर्थी खाली सही करणा-यास महाराष्ट्र प्रादेशिक नगररचना अधिनियम १९६६ चे कलम ५५ " +
                            "अन्वये कारवाई करणेचे अधिकार महाराष्ट्र प्रादेशिक नगररचना अधिनियम १९६६ अन्वये प्रदान केलेले आहेत.\n"+
                            "     आणि ज्या अर्थी माझे असे निदर्शनास आले आहे की तुम्ही खालीलप्रमाणे अनधिकृत/विनापरवाना बांधकाम/विकास केला आहे. त्याअर्थी या " +
                            ...
                            "    या नोटीशीप्रमाणे तुम्ही अनधिकृत बांधकाम/विकास काढून टाकले नाही तर सदरचे बांधकाम/विकास प्राप्त अधिकाराचा" +
                            ...
                            "   अंदाजे मोजमाप - "+p12+" मी. X "+p13+" मी. X "+p14+" मजले = "+p15+" चौ.मी.\n" +
                            ...
                            "\t\t\t\t\t             कार्यकारी अभियंता ( ‘"+p22+" ’ क्षेत्रिय कार्यालय ) \n" +
                            "\t\t\t\t\t          बांधकाम परवानगी व अनधिकृत बांधकाम नियंत्रण विभाग\n" +
                            "\t\t\t\t\t              पिंपरी चिंचवड महानगरपालिका,\n" +
                            "  \t\t\t\t\t                  पिंपरी, पुणे– "+p23+"").getBytes());

                    outputStream.close();

                    Toast.makeText(NoticeFour.this, "File created successfully", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    Toast.makeText(NoticeFour.this, "Fail to create file", Toast.LENGTH_SHORT).show();
                }
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(NoticeFour.this);
                ...
                alertDialogBuilder.setPositiveButton("yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                Intent Fir   = new Intent(NoticeFour.this,NoticeFive.class);

                                Fir.putExtra("name",p5);
                                Fir.putExtra("address",p6);

                                Fir.putExtra("typeB",p26);

                                Fir.putExtra("m1",p12);
                                Fir.putExtra("m2",p13);
                                Fir.putExtra("m3",p14);
                                Fir.putExtra("cal",p15);
...
//submitt end button end
        ...
        Spinner spin2=(Spinner) findViewById(R.id.t22);
        ...
        spin.setOnItemSelectedListener(NoticeFour.this);
...
//calculation
        ...
        t15.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {

                try{
                    if(hasFocus) {
                        double f1=Double.parseDouble(t12.getText().toString());
                        double f2=Double.parseDouble(t13.getText().toString());
                        double f3=Double.parseDouble(t14.getText().toString());
                    ...
                    Toast.makeText(NoticeFour.this, "Please try again", Toast.LENGTH_LONG).show();
                }
            }
        });
        //calculationend
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(NoticeFour.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(NoticeFour.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(NoticeFour.this, "Write External Storage permission allows us to save files. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(NoticeFour.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
...
private void generateReport()
{
    ...
    AsyncTask.execute(new Runnable() {
        @Override
        public void run() {
            if (DocumentContainer.openDocument4(NoticeFour.this,getLayoutInflater(),DocumentContainer.InputstreamFourhoursPhotos3,p5,
                ...
                DocumentContainer.saveReportExternally(NoticeFour.this,getLayoutInflater());//save doc file in the file manager

                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(NoticeFour.this,"Report Genrated Successfully",Toast.LENGTH_LONG).show();
