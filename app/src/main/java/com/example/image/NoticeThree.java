...
public class NoticeThree extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notice_three);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Intent Fir = new Intent(NoticeThree.this, NoticePanel.class);
                startActivity(Fir);
            }
        });
        ///
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    String filename="कलम_५३_(१)_(अ)_"+p5;
                    ...
                    outputStream.write(( "\t\t\t\t\t\t\t\t      पिंपरी चिंचवड महानगरपालिका\n\t\t\t\t" +
                            ...
                            "\t\t\t\t      दिनांक -"+p3+
                            "\n\n\t\t\t\t\t\tपरिशिष्ट-६" +
                            "\n\t\tमहाराष्ट्र प्रादेशिक नगररचना अधिनियम १९६६ कलम ५३ (१)(अ) अन्वये नोटीस" +
                            "\n\nप्रति,"+
                            "\n\tमालक / विकसक / ऑक्युपायर :-" +
                            "\n\t"+p4+" -"+p5+"" +
                            "\n\tपत्ता :- "+p6+" \n" +
                            "\n        ज्या अर्थी खाली सही करणा-यास महाराष्ट्र प्रादेशिक नगररचना अधिनियम १९६६ चे कलम ५३ (१) (अ)" +
                            " अन्वये कारवाई करणेचे अधिकार महाराष्ट्र प्रादेशिक " +
                            "नगररचना अधिनियम १९६६ अन्वये प्रदान केलेले आहेत.\n"+
                            ...
                            ""+p24+" "+p23+"आत हलविण्याचा / काढून टाकणेचा आदेश देणेत येत आहे. तसेच सदरच्या बांधकामाचा/जमिनीचा" +
                            " अनधिकृत वापर तात्काळ थांबविणेचा आदेश देणेत येत आहे \n" +

                            "     या नोटीशीप्रमाणे तुम्ही अनधिकृत बांधकाम/विकास काढून टाकले नाही तर सदरचे बांधकाम/विकास प्राप्त " +
                            ...
                            "  \t\t\t\t\t                  पिंपरी, पुणे– "+p22+"").getBytes());

                    outputStream.close();

                    Toast.makeText(NoticeThree.this, "File created successfully", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    Toast.makeText(NoticeThree.this, "Fail to create file", Toast.LENGTH_SHORT).show();
                }
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(NoticeThree.this);
                ...
                alertDialogBuilder.setPositiveButton("yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                Intent Fir   = new Intent(NoticeThree.this,NoticeFive.class);
...
//submitt end button end
        ...
        spin.setOnItemSelectedListener(NoticeThree.this);
...
//calculation
        ...
        t14.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                try {
                    ...
                    Toast.makeText(NoticeThree.this, "Please try again", Toast.LENGTH_LONG).show();
                }
            }
        });
        //calculationend
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(NoticeThree.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(NoticeThree.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(NoticeThree.this, "Write External Storage permission allows us to save files. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(NoticeThree.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
    ...
    private void generateReport()
    {
        ...
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                if (DocumentContainer.openDocument3(NoticeThree.this,getLayoutInflater(),DocumentContainer.InputstreamFourhoursPhotos3,p5,
                    ...
                    DocumentContainer.saveReportExternally(NoticeThree.this,getLayoutInflater());//save doc file in the file manager

                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(NoticeThree.this,"Report Genrated Successfully",Toast.LENGTH_LONG).show();
